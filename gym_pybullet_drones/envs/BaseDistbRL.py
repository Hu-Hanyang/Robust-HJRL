...
from gym_pybullet_drones.envs.BaseDistb import BaseDistbEnv
from gym_pybullet_drones.utils.enums import DroneModel, Physics, ActionType, ObservationType, ImageType
from gym_pybullet_drones.control.DSLPIDControl import DSLPIDControl

class BaseDistbRLEnv(BaseDistbEnv):
    ...
    def __init__(self,
        ...
        if act in [ActionType.PID, ActionType.VEL, ActionType.ONE_D_PID]:
            ...
            if drone_model in [DroneModel.CF2X, DroneModel.CF2P]:
                ...
                print("[ERROR] in BaseDistbRLEnv.__init()__, no controller is available for the specified drone_model")
    ...
    def _actionSpace(self):
        ...
        if self.ACT_TYPE in [ActionType.RPM, ActionType.VEL, ActionType.PWM]:
            ...
            print("[ERROR] in BaseDistbRLEnv._actionSpace()")
            exit()
    ...
    def _preprocessAction(self,
        ...
        # TODO: Need to check the controller we use before, this function is called in the,step() function, BaseDistb.py 
    ...
    def _observationSpace(self):
        ...
        if self.OBS_TYPE == ObservationType.RGB:
            ...
            print("[ERROR] in BaseDistbRLEnv._observationSpace()")
    
    ################################################################################

    def _computeObs(self):
        #TODO: Resize the observation, done
