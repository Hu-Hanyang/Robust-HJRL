...
class HoverFixedDistbEnv(HoverDistbEnv):
    """Single agent RL problem: hover at position with fixed disturbance type."""
...
class HoverBoltzmannDistbEnv(HoverDistbEnv):
    """Single agent RL problem: hover at position with fixed disturbance type."""

    def __init__(self, *args, **kwargs):
        # Set disturbance_type to 'fixed' regardless of the input
        kwargs['disturbance_type'] = 'boltzmann'
