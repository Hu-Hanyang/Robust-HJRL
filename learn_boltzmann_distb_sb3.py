...
from gym_pybullet_drones.envs.HoverDistb import HoverBoltzmannDistbEnv, HoverFixedDistbEnv
...
def train(settings="training_boltzmann.json", multiagent=False):
   ...
   #### Make save path ###################################
    ...
    #### Create the environment ################################
    if not multiagent:
        train_env = make_vec_env(HoverBoltzmannDistbEnv,
