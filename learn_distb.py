...
def run(distb_type=DEFAULT_DISTURBANCE_TYPE, distb_level=DEFAULT_DISTURBANCE_LEVEL, multiagent=DEFAULT_MA, 
    ...
    if not multiagent:
        test_env = HoverDistbEnv(disturbance_type=distb_type,
                                 distb_level=distb_level,
                                 gui=gui,
                                 obs=DEFAULT_OBS,
                                 act=DEFAULT_ACT,
                                 record=record_video)
        test_env_nogui = HoverDistbEnv(disturbance_type=distb_type, distb_level=distb_level, obs=DEFAULT_OBS, act=DEFAULT_ACT)
    else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--distb_type',         default=DEFAULT_DISTURBANCE_TYPE,      type=str,           help='Type of disturbance to be applied to the drones [None, "fixed", "boltzmann", "random", "rarl", "rarl-population"] (default: "fixed")', metavar='')
    parser.add_argument('--distb_level',        default=DEFAULT_DISTURBANCE_LEVEL,     type=float,         help='Level of disturbance to be applied to the drones (default: 0.0)', metavar='')
